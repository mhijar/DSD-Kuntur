...
Otra compañia:<input name="compania" rows="1" cols="30" type="text" value=>
</small>
...
<small><input name="check" type="checkbox" />La aceptación de la matrícula indica que los padres se comprometen a asegurar que el progreso académico de su hijo(a), su esfuerz	y conducta (fuera y dentro del colegio).

<br>sean en  todo momento, aceptables para el Colegio. El Colegio se reserva el derechi de requerir el retiro  de un estudiante que, en opinión del Headmaster, tenga un progreso</br>
...
<b>Su nombre:</b><input name="nombre" rows="1" cols="500" type="text" value=>
